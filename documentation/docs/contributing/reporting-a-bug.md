...
Data Management is an actively maintained project that we constantly strive
to improve. However, bugs may occur. If you
...
By following this guide, you will know exactly
...
version. Thus, before reporting an issue, ensure that you're having the
[latest version]. Please consult our [upgrade guide] to
learn how to upgrade to the latest version.

!!! warning "Bug fixes are not backported"

    Please understand that only bugs that occur in the latest version of
    Data Management will be addressed. Also, to reduce duplicate efforts,
...
!!! warning "Customizations mentioned in our documentation"
    ...
    A handful of the features Data Management offers can only be implemented
...
in which you're using Data Management, and what you _think_ might be
...
that should be reported to Data Management, and not to one of its
dependencies.[^3] Adhere to the following principles:
  ...
  [^3]:
    ...
    related to Data Management and should be reported upstream. When in
...
!!! warning "Don't share links to repositories"
    ...
    Additionally, there are many non-technical users of Data Management that
...
> the browser version as the first step in the field above.
  ...
  [previewing]: http://localhost:8000/data-management
